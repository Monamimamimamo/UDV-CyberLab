import { CommentDetails, type CommentDTO, useUpdateNewsComment } from '@/entities/comment';
...
export const NewsCommentEditForm = ({ comment, onExit }: CommentActionsProps) => {
  const { mutateAsync: updateComment, isPending } = useUpdateNewsComment();
