...
export const learnMaterialSchema = z.object({
  ...
  shortDescription: z
    ...
    .max(300, 'Краткое описание учебного материала не должно превышать 300 символов'),
  description: z
    .string()
    .min(1, 'Пожалуйста, введите подробное описание учебного материала')
    .max(1500, 'Подробное описание учебного материала не должно превышать 1500 символов'),
