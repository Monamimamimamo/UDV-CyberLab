...
import { AdminTestListWithQuery } from '@/widgets/admin-test-list';
...
const TestsPage = () => {
  ...
  return (
    <section className="mb-20 flex w-full flex-col gap-5 md:flex-row">
      <div className="flex w-full flex-col gap-3">
        ...
        >
          <AdminTestListWithQuery search={search} difficulty={difficulty} subject={subject} />
        </QueryBoundary>
      </div>
      {!isMobile && (
