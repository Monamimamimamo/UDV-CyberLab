...
[ApiController]
[Authorize]
public class LearnMaterialsCardController(INewsCardService _projectService) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost]
    public async Task<IActionResult> CreateProjectCard([FromForm] LearnMaterialCardDto request)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> UpdateProjectCard([FromForm] LearnMaterialCardUpdateDto request)
    {
