...
public static class InfrastuctureStartup
{
        ...
        IConfigurationManager configurationManager)
    {
        ...
        serviceCollection.AddDbContext<LearnMaterialsDbContext>(options => { options.UseNpgsql(connectionString); });

        serviceCollection.AddScoped<DbContext>(provider => provider.GetService<LearnMaterialsDbContext>());
